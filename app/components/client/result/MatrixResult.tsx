    ...
    return (
        <>
            <div className="grid lg:grid-cols-5  px-5  bg-gray-600 py-3	text-white	 mb-10  ">
                ...
                <div>
                    <span>Interpol: </span>
                    <span onClick={(e) => updateFilter("Interpol",e)} className="cursor-pointer	hover:bg-green-400	 inline-flex items-center justify-center px-2 py-1 mr-2 text-xs font-bold leading-none text-red-100 bg-green-600 rounded-full">{total}</span>
